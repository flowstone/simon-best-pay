...
public class WxUtil {
    ...
    public static String generateSignedXml(final Map<String, String> data, String key) throws Exception {
        return generateSignedXml(data, key, WxConstants.MD5);
    }
    ...
    public static boolean isSignatureValid(Map<String, String> data, String key) throws Exception {
        return isSignatureValid(data, key, WxConstants.MD5);
    }
    ...
    public static String generateSignature(final Map<String, String> data, String key) throws Exception {
        return generateSignature(data, key, WxConstants.MD5);
    }
    ...
    public static String generateSignature(final Map<String, String> data, String key, String signType) throws Exception {
        ...
        if (WxConstants.MD5.equals(signType)) {
            return MD5(sb.toString()).toUpperCase();
        }
        else if (WxConstants.HMACSHA256.equals(signType)) {
